...
public class AlertDialog {
    ...
    private boolean isShowGravity = false;
    private boolean showRowSpacing=false;
    private int BLUE_COLOR= Color.BLUE;
    ...
    public AlertDialog setRowSpacing(int rowSpacing){
        showRowSpacing=true;
        return this;
    }
    ...
    public AlertDialog setTextColor(int color){
    ...
    private void setLayout() {
        ...
        if (showRowSpacing){
            //txt_msg.setMarqueeRepeatLimit(1);
            txt_msg.setLineSpacing(1.5f,1.5f);
        }
