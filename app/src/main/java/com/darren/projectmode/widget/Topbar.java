...
public class Topbar extends RelativeLayout {
    ...
    public Topbar(Context context, AttributeSet attrs) {
        ...
        //步骤四：添加控件到ViewGroup中
        leftIcoParams = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
        ...
        rightIcoParams = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
