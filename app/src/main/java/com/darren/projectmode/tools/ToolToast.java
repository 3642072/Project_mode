...
import com.darren.projectmode.widget.AlertDialog;
...
public class ToolToast {
    ...
    public static void showLong(String msg) {
        buildToast(IApplication.getContext(), msg, Toast.LENGTH_LONG).show();
    }
    ...
    public static void showShort(String msg) {
        buildToast(IApplication.getContext(), msg, Toast.LENGTH_SHORT)
                .show();
    }
